...
require 'marginalia/opentelemetry/version'

Gem::Specification.new do |spec| # rubocop:disable Metrics/BlockLength
  spec.name = 'marginalia-opentelemetry'
  spec.version = Marginalia::OpenTelemetry::VERSION
  spec.authors = ['OpenTelemetry developers']
  spec.email = ['sqlcommenter@googlegroups.com']

  spec.summary = 'Adds OpenTelemetry support to Marginalia.'
  ...
  spec.add_development_dependency 'opentelemetry-sdk', '~> 1.2.0'
  spec.add_development_dependency 'opentelemetry-instrumentation-all', '~> 0.33.0'
end
